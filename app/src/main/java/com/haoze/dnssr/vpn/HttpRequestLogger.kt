...
/**
 * HTTP request logger with batch buffering and asynchronous writes. Expiry
...
class HttpRequestLogger(
    ...
    suspend fun log(
        ...
        if (mode == DnsLogMode.BLOCKED_AND_ERRORS &&
            (outcome == HttpRequestOutcome.ALLOWED || outcome == HttpRequestOutcome.PASSTHROUGH)) return
        mutex.withLock {
