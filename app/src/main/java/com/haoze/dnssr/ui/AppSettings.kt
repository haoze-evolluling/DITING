...
/**
 * Unified facade over app settings, backed by SharedPreferences.
 * The concrete storage logic is split into dedicated modules under
 * [com.haoze.dnssr.ui.settings].
 */
object AppSettings {
    ...
    // ============================== Onboarding and initial agreement ==============================
    ...
    // ============================== Domain and address rule master switches ==============================
    ...
    // ============================== Block response and dynamic blocking ==============================
    ...
    // ============================== Background hiding and LAN splitting ==============================
    ...
    // ============================== Per-app domain allow rules (formerly app whitelist) ==============================
    ...
    // ============================== Agent (AI) API settings ==============================
    fun getAgentApiConfig(context: Context): com.haoze.dnssr.ui.settings.AgentApiConfig =
        com.haoze.dnssr.ui.settings.AgentApiSettingsStore.getAgentApiConfig(context)
    fun setAgentApiConfig(context: Context, config: com.haoze.dnssr.ui.settings.AgentApiConfig) =
        com.haoze.dnssr.ui.settings.AgentApiSettingsStore.setAgentApiConfig(context, config)

    // ============================== Startup self-check and config repair ==============================
