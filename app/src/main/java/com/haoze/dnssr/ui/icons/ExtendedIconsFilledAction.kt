...
public val Icons.Filled.HelpOutline: ImageVector
    get() {
        ...
        _helpOutline = materialIcon(name = "Filled.HelpOutline") {
            materialPath {
                moveTo(11.0f, 18.0f)
                horizontalLineToRelative(2.0f)
                verticalLineToRelative(-2.0f)
...
public val Icons.Filled.WorkspacePremium: ImageVector
    get() {
        if (_workspacePremium != null) {
            return _workspacePremium!!
        }
        _workspacePremium = materialIcon(name = "Filled.WorkspacePremium") {
            materialPath {
                moveTo(9.68f, 13.69f)
                lineTo(12.0f, 11.93f)
...
public val Icons.Filled.Troubleshoot: ImageVector
    get() {
        if (_troubleshoot != null) {
            return _troubleshoot!!
        }
        _troubleshoot = materialIcon(name = "Filled.Troubleshoot") {
            materialPath {
                moveTo(22.0f, 20.59f)
