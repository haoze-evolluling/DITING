...
internal fun translateNetworkToolsExact(text: String): String? = when (text) {
    ...
    "网络调试工具在设备本机执行 Ping 与 DNS 查询，不经过谛听 VPN。" -> "Network diagnostics run ping and DNS queries directly on this device and do not go through the DITING VPN."
