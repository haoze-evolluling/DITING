...
object CrashCollector {
    ...
    fun collectReport(
        ...
        appendSection(sb, "APPLICATION INFORMATION") {
            ...
            val appName = runCatching { context.applicationInfo.loadLabel(pm).toString() }.getOrDefault("DITING")
    ...
    fun collectNativeCrashReport(
        ...
        val sb = StringBuilder(8192)
        sb.append("================================================================================\n")
        sb.append("                       DITING NATIVE CRASH REPORT\n")
        sb.append("================================================================================\n\n")
