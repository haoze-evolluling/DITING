package com.haoze.diting.update
...
/**
 * Shared in-app update state and flow (check / download / install / notify)
 * for host activities, deduplicating the implementations that previously
 * existed in both MainActivity and SettingsRouteActivity.
 */
class AppUpdateHost(private val activity: ComponentActivity) {
    ...
    /** Cancels any in-flight download and clears notifications when the host goes to the background. */
