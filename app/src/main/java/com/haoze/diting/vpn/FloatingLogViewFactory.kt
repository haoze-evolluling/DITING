...
object FloatingLogViewFactory {
    ...
    fun createBallView(context: Context, density: Float): ImageView {
        return ImageView(context).apply {
            ...
            setImageResource(com.haoze.diting.R.mipmap.ic_launcher)
    ...
    fun createPanelView(
        ...
        header.addView(createHeaderButton(
            context = context,
            density = density,
            icon = com.haoze.diting.R.drawable.ic_overlay_minimize,
        ...
        header.addView(createHeaderButton(
            context = context,
            density = density,
            icon = com.haoze.diting.R.drawable.ic_overlay_resize,
        ...
        header.addView(createHeaderButton(
            context = context,
            density = density,
            icon = com.haoze.diting.R.drawable.ic_overlay_close,
