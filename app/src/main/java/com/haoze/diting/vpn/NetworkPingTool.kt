...
object NetworkPingTool {
    ...
    suspend fun ping(
        ...
        timeoutSeconds: Int = PING_TIMEOUT_SECONDS,
        ...
        return withContext(Dispatchers.IO) {
            try {
                withTimeout((count * (timeoutSeconds + 3) + 15) * 1000L) {
                    runPing(sanitized, count.coerceIn(1, 20), timeoutSeconds, addressOverride)
                }
    ...
    private fun runPing(target: String, count: Int, timeoutSeconds: Int, addressOverride: String?): Summary {
